...
TEST(LandmarkGraph, All)
{
  ...
  g.UpdateEdge(123, 456, 1.0f, -5.0f, 5.0f);
  EXPECT_EQ(2ul, g.GraphSize());

  // Edge v1/v2 should be symmetric.
  g.UpdateEdge(456, 123, 1.0, -5.0, 5.0);  // Now added to subgraph.
  EXPECT_EQ(2ul, g.GraphSize());
  ...
  g.UpdateEdge(123, 456, -6.0, -2.0, 2.0);
  EXPECT_EQ(2ul, g.GraphSize());
  ...
  g.UpdateEdge(123, 456, 4.0, -2.0, 2.0);
